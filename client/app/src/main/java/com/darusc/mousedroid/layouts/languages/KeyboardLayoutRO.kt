...
class KeyboardLayoutRO : KeyboardLayout() {
    ...
    override val charMap = mapOf(
        ...
        '@' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_2),
        '3' to Key(Keycode.MOD_NONE, Keycode.KEY_3),
        '#' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_3),
        '4' to Key(Keycode.MOD_NONE, Keycode.KEY_4),
        '$' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_4),
        '5' to Key(Keycode.MOD_NONE, Keycode.KEY_5),
        '%' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_5),
        '6' to Key(Keycode.MOD_NONE, Keycode.KEY_6),
        '^' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_6),
        '7' to Key(Keycode.MOD_NONE, Keycode.KEY_7),
        '&' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_7),
        '8' to Key(Keycode.MOD_NONE, Keycode.KEY_8),
        '*' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_8),
        '9' to Key(Keycode.MOD_NONE, Keycode.KEY_9),
        '(' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_9),
        '0' to Key(Keycode.MOD_NONE, Keycode.KEY_0),
        ')' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_0),
        ...
        '[' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_LEFT_BRACE),
        '{' to Key(Keycode.MOD_RIGHT_ALT or Keycode.MOD_LEFT_SHIFT, Keycode.KEY_LEFT_BRACE),
        ']' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_RIGHT_BRACE),
        '}' to Key(Keycode.MOD_RIGHT_ALT or Keycode.MOD_LEFT_SHIFT, Keycode.KEY_RIGHT_BRACE),
        '\\' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_BACKSLASH),
        '|' to Key(Keycode.MOD_RIGHT_ALT or Keycode.MOD_LEFT_SHIFT, Keycode.KEY_BACKSLASH),
        ';' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_SEMICOLON),
        ':' to Key(Keycode.MOD_RIGHT_ALT or Keycode.MOD_LEFT_SHIFT, Keycode.KEY_SEMICOLON),
        '\'' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_QUOTE),
        '"' to Key(Keycode.MOD_RIGHT_ALT or Keycode.MOD_LEFT_SHIFT, Keycode.KEY_QUOTE),
        '`' to Key(Keycode.MOD_RIGHT_ALT, Keycode.KEY_GRAVE),
        '~' to Key(Keycode.MOD_RIGHT_ALT or Keycode.MOD_LEFT_SHIFT, Keycode.KEY_GRAVE),
        ...
        'ă' to Key(Keycode.MOD_NONE, Keycode.KEY_LEFT_BRACE),
        'Ă' to Key(Keycode.MOD_LEFT_SHIFT, Keycode.KEY_LEFT_BRACE),
        'î' to Key(Keycode.MOD_NONE, Keycode.KEY_RIGHT_BRACE),
        'Î' to Key(Keycode.MOD_LEFT_SHIFT, Keycode.KEY_RIGHT_BRACE),
        'â' to Key(Keycode.MOD_NONE, Keycode.KEY_BACKSLASH),
        'Â' to Key(Keycode.MOD_LEFT_SHIFT, Keycode.KEY_BACKSLASH),
        'ș' to Key(Keycode.MOD_NONE, Keycode.KEY_SEMICOLON),
        'Ș' to Key(Keycode.MOD_LEFT_SHIFT, Keycode.KEY_SEMICOLON),
        'ț' to Key(Keycode.MOD_NONE, Keycode.KEY_QUOTE),
        'Ț' to Key(Keycode.MOD_LEFT_SHIFT, Keycode.KEY_QUOTE)
    )
}